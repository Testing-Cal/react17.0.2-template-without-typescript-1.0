...
function Home() {
  ...
  return (
    <div className="App">
      <textarea style={{fontWeight:'800', size: '48px'}} className="col-md-6 text-center border-0 form-control blockquote" value={title} onChange={/*istanbul ignore next*/e=>setTitle(e.target.value)}/><br/>
